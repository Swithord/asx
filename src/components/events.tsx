...
export default function Events() {
    ...
    return (
        <Container className="events">
            <h1>Events</h1>
            <h5>We organise a variety of events to engage with the community and share our passion for space. Our regular events are free and open to the public without registration required.</h5>
